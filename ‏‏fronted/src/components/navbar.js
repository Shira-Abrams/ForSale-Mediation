...
import {  Logout, Margin } from '@mui/icons-material';
      ...
      <Container maxWidth="xl">
       ...
       <Box sx={{ flexGrow: 0 }}>
        ...
        >
            ...
            <MenuItem  onClick={setProfile}>
              <Typography textAlign="center">הגדרות פרופיל</Typography>
            </MenuItem>
            <MenuItem  onClick={adPropNavigate}>
              <Typography textAlign="center">מודעות שפרסמתי </Typography>
            </MenuItem>
            <MenuItem  onClick={SavedSearch}>
              <Typography textAlign="center">חיפשוים שמורים</Typography>
            </MenuItem>
            <MenuItem  onClick={uploadAd}>
              <Typography textAlign="center">העלאת מודעה</Typography>
            </MenuItem>
